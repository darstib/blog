...
// Callouts
    {trigger: "> note", replacement: "> [!note]+ $0", options: "tA"},
    {trigger: "> abs", replacement: "> [!abstract]- $0", options: "tA"},
    {trigger: "> sum", replacement: "> [!summary]- $0", options: "tA"},
    {trigger: "> tldr", replacement: "> [!tldr]+ $0", options: "tA"},
    {trigger: "> info", replacement: "> [!info]- $0", options: "tA"},
    {trigger: "> todo", replacement: "> [!todo]+ $0", options: "tA"},
    {trigger: "> tip", replacement: "> [!tip]- $0", options: "tA"},
    {trigger: "> hint", replacement: "> [!hint]- $0", options: "tA"},
    {trigger: "> imp", replacement: "> [!important]+ $0", options: "tA"},
    ...
    {trigger: "> caut", replacement: "> [!caution] $0", options: "tA"},
    {trigger: "> atten", replacement: "> [!attention] $0", options: "tA"},
    {trigger: "> fail", replacement: "> [!failure] $0", options: "tA"},
    {trigger: "> danger", replacement: "> [!danger]+ $0", options: "tA"},
    {trigger: "> bug", replacement: "> [!bug] $0", options: "tA"},
    {trigger: "> exam", replacement: "> [!example]- $0", options: "tA"},
    {trigger: "> quote", replacement: "> [!quote] $0", options: "tA"},
    {trigger: "> def", replacement: "> [!definition]- $0", options: "tA"},
    {trigger: "> theo", replacement: "> [!theorem]+ $0", options: "tA"},
    {trigger: "> lem", replacement: "> [!lemma]- $0", options: "tA"},
    {trigger: "> wiki", replacement: "> [!wiki]- $0", options: "tA"},
    {trigger: "> proof", replacement: "> [!proof]- $0", options: "tA"},
    {trigger: "> env", replacement: "> [!env]- $0", options: "tA"},
    {trigger: "> prereq", replacement: "> [!prerequisite]- $0", options: "tA"},
    {trigger: "> know", replacement: "> [!knowledge]- $0", options: "tA"},
    {trigger: "> demo", replacement: "> [!demo]- $0", options: "tA"},
    {trigger: "> math", replacement: "> [!math]+ $0", options: "tA"},
    {trigger: "> extra", replacement: "> [!extra]- $0", options: "tA"},
    {trigger: "> flag", replacement: "> [!flag]- $0", options: "tA"},
