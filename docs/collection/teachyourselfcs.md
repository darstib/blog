...
- [python](https://www.python.org/)（python 的应用性已经是无需多提了）
...
- [图灵班课程学习指南](https://zju-turing.github.io/TuringCourses/)
	- ZJU 校内课程的指点
- [CS-Engineering](https://zjuxlab.github.io/cs-engineering/)
	- 致力于打造一份优质CS工程文档合集，目前聚焦于前后端
...
- [3Blue1Brown - 线性代数的本质](https://www.bilibili.com/video/BV1ys411472E/?spm_id_from=333.999.0.0&vd_source=0a037c4dd2becee04d2b1ccafdc1862e)
...
- [Introduction to Generative AI 2024 Spring](https://speech.ee.ntu.edu.tw/~hylee/genai/2024-spring.php)
    ...
    - 课程本身非常浅显易懂，让学生迅速理解了什么是生成式人工智能；同时老师讲课诙谐有趣，会引用一些热门动漫中的剧情（这里引用比较多的是[葬送的芙莉莲](https://zh.wikipedia.org/wiki/%E8%91%AC%E9%80%81%E7%9A%84%E8%8A%99%E8%8E%89%E8%93%AE "葬送的芙莉莲")）；
...
- [CS:APP3e](https://csapp.cs.cmu.edu/)
    ...
    - [Lab 详解](https://kkee.top/docs/system/CSAPP) or [北大版 Lab 详解](https://arthals.ink/categories/experience)
