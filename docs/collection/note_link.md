...
- 参考书
	- [统计学习方法v2](../static/统计学习方法v2.pdf) （主要参考教材，仅供学习参考使用）
...
- [数据安全与密码学基础 Cheatsheet & Homework](https://zzw4257.cn/posts/is-pro/%E5%AF%86%E7%A0%81%E5%AD%A6/#contest)

### 计算机系统 II (sys-II)

- [CSys-II](https://darstib.github.io/blog/note/CSys-II)
- [鹤翔万里的笔记本](https://note.tonycrane.cc/cs/system/cs2/)
- [24-25秋冬 计算机系统Ⅱ期末回忆卷](https://www.cc98.org/topic/6089253)
...
> [!extra]- 学后感
>
> 前期和计逻差不多（大致到时序逻辑电路），后面 sys I 为了和之后的内容接轨而开始有所不同
