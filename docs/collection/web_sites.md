...
> [!extra]- 20250421 更新
> 
> 随着 DeepSeek-r1 等等模型的开源，越来越多的可符合生产需求的模型都可以直接在官网（一定限制地）使用了，所以之前这里列举的第三方网站属实没有其必要性，在此仅推荐几个我认为当前 SOTA（State-Of-The-Art，即行业领先） 的模型官网：(顺序仅代表本人的使用频率)

- [Google AI Studio](https://aistudio.google.com/) 或者 [Gemini](https://gemini.google.com/)
- [Qwen(千问)](https://chat.qwen.ai/) 或者 [通义](https://www.tongyi.com/)
...
- [namebeta](https://namebeta.com/)
    - 域名价格查询
- [whatismyipaddress](https://whatismyipaddress.com/) or [whoer](https://whoer.net/zh)
    - 获取 ip 地址
...
- 英文论文翻译
	- [ChatPaper](https://github.com/kaixindelele/ChatPaper)
		...
		- [示例教程](https://zhuanlan.zhihu.com/p/692337102)
		- [zh_Traced ICSE 24](../static/zh_Traced%20ICSE%2024.pdf){:download="zh_Traced ICSE 24"} 是一个成功例子
	- [有道在线翻译](https://fanyi.youdao.com/#/AITranslate)
		- 有道的翻译也不错，其 [arXiv 论文翻译](https://fanyi.youdao.com/trans/#/home)排版效果也挺好
...
- [godbolt](https://godbolt.org/)
	...
	- 其他“知名”代码床：[Github gist](https://gist.github.com/) or [LeetCode/playground](https://leetcode.com/playground/) or [One Compiler](https://onecompiler.com/)
...
- [Office PLUS](https://www.officeplus.cn/Template/Home.shtml) (官网模板)
- [比格PPT](http://www.tretars.com)
- [当热PPT](http://ppt.downhot.com)
- [叮当设计](http://www.dingdangsheji.com)
- [办公资源](http://www.bangongziyuan.com)
- [稻壳儿 (WPS)](https://www.docer.com/) (修正链接)
- [顶尖PPT](http://www.gfxaa.com)

### 颜色

- [colorsupplyyy](https://colorsupplyyy.com/palettes)
- [Color Space](https://mycolor.space/)
- [Adobe Color](https://color.adobe.com/zh/create/color-wheel)
- [中国色](http://zhongguose.com/) (注意是 http)
...
- [Color Scheme Designer (Wauu)](https://www.wauu.net/tools/ps/)
- [Pantone 中国](http://www.pantone.net.cn/pantone/index.htm) - 潘通年度流行色
- [uiGradients](https://uigradients.com/) - 渐变颜色方案
- [Grabient](https://www.grabient.com/) - 制作渐变
- [WebGradients](https://webgradients.com/) - 双色渐变方案
- [Palettable](https://www.palettable.io/) - 智能配色
- [Peise 在线配色器](http://www.peise.net/tools/web)
- [小蝴蝶 RGB 取色器](http://xiaohudie.net/RGB.html)
- [Color Hunt](https://colorhunt.co/) - 每日更新配色方案
- [COLOURlovers](https://www.colourlovers.com/) - 色彩社区与论坛
...
- [Instant Logo Search](https://instantlogosearch.com/) - Logo 搜索
- [unDraw](https://undraw.co/illustrations) - 免费矢量插画，统一风格
- [FreeVector.com](https://www.freevector.com/) - 矢量素材
- [Pixabay](https://pixabay.com/)
- [StockSnap.io](https://stocksnap.io/)
- [沙沙野](https://www.ssyer.com/home)
- [StreetWill](http://www.streetwill.co/)
- [图鱼网](http://www.hituyu.com/) - 纹理背景
...
- [腾讯 YCG 原创馆](https://ycg.qq.com/)
- [The Inspiration Grid](https://theinspirationgrid.com/) - 全球新奇设计创意
- [Lapa Ninja](https://www.lapa.ninja) - Landing Page 设计欣赏 (修正链接)
- [古田路9号](http://www.gtn9.com) - 品牌创意设计社区
- [UI 中国](https://www.ui.cn/) - UI 设计社区
...
- [CG模型网](http://www.cgmodel.com/)

### 文字云制作

- [WordArt.com](https://wordart.com/)
- [Word2Art](http://www.word2art.com/) - 文字云动画
	- 使用教程：[超强神器推荐：文字云，应该这么玩！](https://mp.weixin.qq.com/s?__biz=MzU0Mjk4NzU1NA==&mid=2247487684&idx=1&sn=48147b8f98b613572c1c1e882fe6f59a&chksm=fb131489cc649d9f86e08f4c8a5ad6c77a568b7bdb9a72a61016bab1915bbf977c4549beb9b0&mpshare=1&scene=23&srcid=#rd)

### 其他

- [秀米](https://xiumi.us/#/)
- [bazier game](https://bezier.method.ac/)
	- PS 的钢笔工具练习网站
