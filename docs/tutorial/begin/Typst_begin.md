...
一个语法简单的介绍使用可见我使用 touyin 做的 [typst_cheatsheet](../../static/typst_cheatsheet.pdf)【[源码](../../static/typst_cheatsheet.zip) 】 笔记，使用 [touyin](https://touying-typ.github.io/zh/) 模板；[Typst Examples Book](https://sitandr.github.io/typst-examples-book/book/) 也是一个很好的入门和进阶教程。
