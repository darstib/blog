...
>
> - 使用安装了 Linux 系统的电脑，或者是 macOS 等类 Unix 系统；
> - 对于 Windows 用户，你可以：
>     - 使用 [WSL(Windows Subsystem for Linux)](https://docs.microsoft.com/zh-cn/windows/wsl/)；
>     - 使用 [VMware](https://support.broadcom.com/group/ecx/productdownloads?subfamily=VMware+Workstation+Pro&freeDownloads=true&tab=Products) 等软件运行 Linux 虚拟机。
> 
>> [!extra]-
>> 
