...
### 混合策略纳什均衡计算：最优反应与无差异原则 (page 12-20)
...
#### 无差异原则 (Indifference Principle) (page 16-20)
...
### 引入：蜈蚣博弈 (Centipede Game) (page 24)
...
### 基本概念：扩展式博弈 (Extensive-Form Game) (page 25-27)
...
### 子博弈完美均衡 (Subgame Perfect Equilibrium, SPE) (page 30-36)
...
### 逆向归纳法 (Backward Induction) (page 37-40)
...
### 产量领导模型 (Stackelberg Model, 斯塔克尔伯格模型) (page 41-47)
...
### 不完全信息博弈的均衡：贝叶斯纳什均衡 (Bayesian Nash Equilibrium) (page 59-65)
