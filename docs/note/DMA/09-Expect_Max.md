...
> &=\sum_{k=1}^K\left\{\sum_{j=1}^N\left(E\gamma_{jk}\right)\log\alpha_k+\\
> \sum_{j=1}^N\left(E\gamma_{jk}\right)\left[\log\left(\frac{1}{\sqrt{2\pi}}\right)- \log\sigma_k-\frac{1}{2\sigma_k^2}\left(y_j-\mu_k\right)^2\right]\right\}
> \end{aligned}$$
> 
